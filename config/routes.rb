Rails.application.routes.draw do
  ...
  match '/indextheme',  to: 'themes#index',            via: 'get'
  ...
  match '/dltchartoscene',   to: 'relations#deleteChrtoSce',           via: 'get'
  match '/dltscenetochap',   to: 'relations#deleteScetoChp',           via: 'get'
  match '/dltanectochap',   to: 'relations#deleteAnetoChp',           via: 'get'
  match '/dltthemtoanec',   to: 'relations#deleteThetoAne',           via: 'get'
  match '/chartoscene',   to: 'relations#newChrtoSce',           via: 'get'
  match '/scenetochap',   to: 'relations#newScetoChp',           via: 'get'
  match '/anectochap',   to: 'relations#newAnetoChp',           via: 'get'
  match '/themtoanec',   to: 'relations#newThetoAne',           via: 'get'
  match '/character',   to: 'characters#new',           via: 'get'
  match '/anecdote',   to: 'anecdotes#new',           via: 'get'
  match '/chapter',   to: 'chapters#new',           via: 'get'
  match '/theme',   to: 'themes#new',           via: 'get'
  match '/rltnChrtoSce',   to: 'relations#createChrtoSce',           via: 'post'
  match '/rltnScetoChap',   to: 'scenes#createScetoChap',           via: 'post'
  match '/rltnAnetoChap',   to: 'anecdotes#createAnetoChap',           via: 'post'
  match '/rltnThetoAne',   to: 'themes#createThetoAne',           via: 'post'
  ...
  match '/theme',   to: 'themes#create',        via: 'post'
  match '/deleteChrtoSce', to: 'relations#destroy',     via: 'post'
  match '/deleteScetoChp', to: 'scenes#destroy',     via: 'post'
  match '/deleteAnetoChp', to: 'anecdotes#destroy',     via: 'post'
  match '/deleteThetoAne', to: 'themes#destroy',     via: 'post'
